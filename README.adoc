...
|*{minio-chart-version}* |{original-repo-url}[Chart] |https://artifacthub.io/packages/helm/minio-official/minio/{chart-version}?modal=values[`values.yaml`]
|===
