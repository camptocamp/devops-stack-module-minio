...
==== [[output_minio_root_secretkey]] <<output_minio_root_secretkey,minio_root_secretkey>>
...
|[[output_minio_root_secretkey]] <<output_minio_root_secretkey,minio_root_secretkey>> |Minio RootUser
|===
// END_TF_TABLES
====
