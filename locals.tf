  ...
  oidc_config = merge(
    {
      oidc = {
        ...
        clientSecret = "<path:secret/data/devops-stack/submodules/minio#minio-oidc-client-secret>"
        claimName    = "policy"
    ...
    minio = merge(
      {
        ...
        rootUser     = "root"
        rootPassword = "<path:secret/data/devops-stack/submodules/minio#minio-root-secretkey>"
